...
public class PokemonRank {
	...
	public static void main(String[] args) throws IOException {
		...
		while (br.ready()) {
			...
			int remainderSize = Integer.parseInt(data[data.length-1]);
			System.out.println(rank(pokemon, remainderSize));
		}
		br.close();
	}
	public static boolean rank(int[] pokemon, int remainderSize) {
